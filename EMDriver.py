...
class EMDriver:
    def __init__(self, port="/dev/ttyUSB0", baudrate=115200, waitime=1e-3, prescaler=1):
    ...
    def counter(self, des_frequency):
        return int(32e6/(self.prescaler+1)/(des_frequency))
...
if __name__=="__main__":
    driver=EMDriver(port="/dev/ttyUSB0", baudrate=115200, waitime=1e-3, prescaler=128)
    driver.stop()
